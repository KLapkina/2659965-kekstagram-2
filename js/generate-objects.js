...
const createCommentsArray = () => {
  const commentsArray = [];
  const count = createRandomRangeInteger(
    NumberOfComments.MIN,
...
const createDescriptionsPhotoArray = () =>
  Array.from({ length: 25 }, createDescriptionPhoto);
